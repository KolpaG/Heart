...
for (i = 0; i < Math.PI * 2; i += dr) pointsOrigin.push(scaleAndTranslate(heartPosition(i), 250, 15, 0, 0)); // İÇ KATMAN BÜYÜTÜLDÜ
    ...
    var targetPoints = [];
    // Kalp atışı (pulse) etkisi için noktaları yeniden hesaplama
    ...
    var config = {
        traceK: 0.4,
        // --- ANİMASYON SÜRESİ UZATILDI / HIZ YAVAŞLATILDI (0.01 -> 0.005) ---
        timeDelta: 0.012
        // ----------------------------------------------------------------------
    };
